            ...
            <section class="secPainel">
                <div class="row barra-ferramentas" style="padding-left: 10px; display: flex; align-items: center">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="btn-group btn-group-justified" role="group" aria-label="...">
                            <div class="btn-group div-btn-exportar" role="group">
                            <button type="button" id="GERARCOMISSAO" class="btn btn-principal" data-loading-text="<i class='flaticon flaticon-monetization-on icon-md'></i> Carregando ..."><i class="flaticon flaticon-monetization-on icon-sm"></i><b> - GERAR</b></button>
                            </div>
                        </div>
                    </div>
                    -->
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="btn-group btn-group-justified" role="group" aria-label="...">
                            <div class="btn-group div-btn-exportar" role="group">
                            <button type="button" id="BAIXARARQUIVO" class="btn btn-ans dropdown-toggle btn-exportar" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Exportar"><i class="fas fa-download"></i><b> - DOWNLOAD</b></button>
